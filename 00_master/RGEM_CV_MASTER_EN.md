...
*Leading the AI division to deliver state-of-the-art Deep Tech solutions for national security and critical infrastructure. Ownership of architectural decisions constrained by security (ENS, defence-grade requirements), operational deployment (edge, real-time, C4I integration), and certification/auditability.*
...
- **Predictive Maintenance & Fleet Readiness (MAPRE - Spanish Navy)**:
  ...
  - **Technical-to-Operational Translation**: Advanced the system from research PoC (TRL 3) to pre-production pilot (TRL 6), ensuring long-term operability in edge-disconnected maritime environments.
  - **Team Leadership**: Coordinated **cross-functional teams** of AI engineers, naval domain experts, and IoT specialists.

#### **Strategic Programmes: Energy & Critical Infrastructure**

- **Autonomous Grid Control (ENIGMA - Red Eléctrica de España)**:
...
- **Digital Twin Optimization (ePROA - Offshore Wind)**:
  ...
  - **Strategic Impact**: Extended asset lifespan and lowered Operational & Maintenance (O&M) costs through predictive optimization, directly contributing to bottom-line ROI for energy operators.
  - **Institutional Trust**: Long-term relationship with energy sector demonstrating repeatability and credibility.

#### **Strategic Programmes: Materials Discovery & Advanced Physics**
...
### Academic Background
- **Bachelor of Engineering in Industrial Automation** | Universidad Politécnica de Madrid (UPM) | *1996 - 2001*
  - *Core foundation in industrial systems, control theory, and engineering strategy.*

### Specialized Certification Program
1. **Deep Learning Specialization** (deeplearning.ai) - *Advanced proficiency in neural networks and architecture design.*
2. **Machine Learning** (Stanford Online University) - *Rigorous academic foundation in ML algorithms.*
3. **Professional Program in Data Science** (Microsoft) - *Applied data science at enterprise scale.*
4. **Machine Learning Specialization** (University of Washington) - *Comprehensive coverage of regression, classification, and clustering.*
5. **Big Data Specialization** (University of California San Diego) - *Scalable data systems and architecture.*
6. **Self-Driving Car Engineer Nanodegree** (Udacity) - *Applied computer vision and sensor fusion.*
7. **Deep Learning Nanodegree** (Udacity) - *Practical implementation of deep neural networks.*
